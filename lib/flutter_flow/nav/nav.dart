...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/serverSettings',
          builder: (context, params) => const ServerSettingsWidget(),
        ),
        FFRoute(
          name: 'chat_2_details',
          path: '/chat2Details',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/enrico.loki_cheshire_cat_is_chatting_with_other_cats_15ee23bd-9aa9-44b9-a19b-7f9d440e1153.png',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
