...
import '/chat_group_wbubbles/chat_thread_update/chat_thread_update_widget.dart';
import '/chat_group_wbubbles/empty_state_simple/empty_state_simple_widget.dart';
import '/chat_group_wbubbles/url_message/url_message_widget.dart';
...
class _ChatThreadComponentWidgetState extends State<ChatThreadComponentWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.returnedSocket = await actions.initSocket(
        () async {
          await showDialog(
            context: context,
            builder: (dialogContext) {
              return Dialog(
                ...
                child: const UrlMessageWidget(),
              );
            },
          ).then((value) => setState(() {}));
        },
      );
      if (_model.returnedSocket != null) {
        setState(() {
          FFAppState().socket = _model.returnedSocket!;
        });
      } else {
        // error message
        await showDialog(
          ...
          builder: (alertDialogContext) {
            return AlertDialog(
              ...
              content: const Text('socket non initialized'),
              actions: [
                TextButton(
                      ...
                      return Container(
                        ...
                        child: wrapWithModel(
                          ...
                          child: ChatThreadUpdateWidget(
                            key: Key(
                              'Keysp0_${listViewChatMessagesRecord.reference.id}',
                            ),
